    ...
    return (
        <Link to={`/players/${player.name}`}>
            <div className="flex flex-row">
                ...
                <div className={`flex items-center bg-surface-1 rounded-r-lg p-2 gap-2 w-full`}>
                    <ProfilePicture pictureUrl="https://dqzvgunkova5o.cloudfront.net/statics/2025-06-20/images/NW-bug.svg" size={32} />
                    <div className="flex flex-col">
                        <div className="flex flex-row items-end text-foreground gap-2">
                            <div className="text-lg font-semibold ">{player.name}</div>
                        </div>
                        <div className="flex flex-row gap-2 items-end text-foreground text-xs">

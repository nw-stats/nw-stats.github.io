                ...
                <div className="grid grid-rows-7 w-full text-white mx-auto">
                    ...
                    <div className="grid grid-cols-[1fr_50px_1fr] w-full items-center">
                        <div className={`${attackerColor} flex items-center justify-center font-semibold  p-2 w-full h-full ${attackerBorder} border-b-2`}>
                            {goldStar ? <StarIcon className="text-yellow-400 w-full" weight="fill" /> : <NumberCell value={attackerSummary?.kills ?? 0} />}
                        </div>
                        ...
                        <div className={`${defenderColor} flex items-center justify-center font-semibold  p-2 w-full h-full ${defenderBorder} border-b-2`}>
                            {goldStar ? <StarIcon className="text-yellow-400 w-full" weight="fill" /> : <NumberCell value={defenderSummary?.kills ?? 0} />}
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-[1fr_50px_1fr] w-full items-center">
                        <div className={`${attackerColor} flex items-center justify-center font-semibold  p-2 w-full h-full ${attackerBorder} border-b-2`}>
                            {goldStar ? <StarIcon className="text-yellow-400 w-full" weight="fill" /> : <NumberCell value={attackerSummary?.deaths ?? 0} />}
                        </div>
                        ...
                        <div className={`${defenderColor} flex items-center justify-center font-semibold  p-2 w-full h-full ${defenderBorder} border-b-2`}>
                            {goldStar ? <StarIcon className="text-yellow-400 w-full" weight="fill" /> : <NumberCell value={defenderSummary?.deaths ?? 0} />}
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-[1fr_50px_1fr] w-full items-center">
                        <div className={`${attackerColor} flex items-center justify-center p-2 font-semibold  w-full h-full ${attackerBorder} border-b-2`}>
                            {goldStar ? <StarIcon className="text-yellow-400 w-full" weight="fill" /> : <NumberCell value={attackerSummary?.assists ?? 0} />}
                        </div>
                        ...
                        <div className={`${defenderColor} flex items-center justify-center p-2 font-semibold  w-full h-full ${defenderBorder} border-b-2`}>
                            {goldStar ? <StarIcon className="text-yellow-400 w-full" weight="fill" /> : <NumberCell value={defenderSummary?.assists ?? 0} />}
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-[1fr_50px_1fr] w-full items-center">
                        <div className={`${attackerColor} flex items-center justify-center p-2 font-semibold  w-full h-full ${attackerBorder} border-b-2`}>
                            {goldStar ? <StarIcon className="text-yellow-400 w-full" weight="fill" /> : <NumberCell value={attackerSummary?.healing ?? 0} />}
                        </div>
                        ...
                        <div className={`${defenderColor} flex items-center justify-center p-2 font-semibold  w-full h-full ${defenderBorder} border-b-2`}>
                            {goldStar ? <StarIcon className="text-yellow-400 w-full" weight="fill" /> : <NumberCell value={defenderSummary?.healing ?? 0} />}
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-[1fr_50px_1fr] w-full items-center">
                        <div className={`${attackerColor} rounded-bl-lg flex items-center justify-center p-2 font-semibold  w-full h-full`}>
                            {goldStar ? <StarIcon className="text-yellow-400 w-full" weight="fill" /> : <NumberCell value={attackerSummary?.damage ?? 0} />}
                        </div>
                        ...
                        <div className={`${defenderColor} rounded-br-lg flex items-center justify-center p-2 font-semibold  w-full h-full`}>
                            {goldStar ? <StarIcon className="text-yellow-400 w-full" weight="fill" /> : <NumberCell value={defenderSummary?.damage ?? 0} />}
                        </div>
                    </div>
                </div>
            </div >
